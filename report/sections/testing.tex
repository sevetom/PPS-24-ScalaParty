...
Le tecnologie utilizzata per il testing del progetto è \verb|org.scalatest| che permette di scrivere test in modo semplice e 
chiaro in modo che i test siano facilmente comprensibili. La libreria è inoltre supportata da IntelliJ (l'IDE utilizzato per lo
sviluppo) e permette di eseguire i test direttamente dall'IDE, rendendo il processo di testing più veloce.

\subsection{Grado di copertura} \label{subsec:testing-coverage}
Il grado di copertura dei test è del 33\%, come mostrato anche a Figura \ref{fig:coverage-report}. Analizzando meglio il report,
...
\subsection{Altri elementi utili} \label{subsec:testing-other-elements}