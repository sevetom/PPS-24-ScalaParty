...
\begin{itemize}
    ...
    complessi; inoltre il caricamento dell'applicazione dev'essere rapido non superando i 5 secondi
    \item \textbf{Robustezza}: il sistema deve essere in grado di gestire input errati o non validi senza andare in crash
    ...
    \item \textbf{Portabilità}: il sistema deve essere in grado di funzionare su diverse piattaforme e dispositivi 
    che supportino la JVM senza richiedere modifiche significative al codice sorgente, 
    garantendo un'esperienza utente coerente su tutti i dispositivi
