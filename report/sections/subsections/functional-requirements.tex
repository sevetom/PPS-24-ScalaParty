...
\begin{itemize}
      ...
      \item L'utente può in ogni momento visualizzare la posizione attuale di ogni giocatore
            sulla plancia.
      \item L'utente può lanciare uno o due dadi, durante il proprio turno, per muovere il proprio
            personaggio.
      ...
      \item L'utente può partecipare a un minigioco alla fine di ogni ciclo di turni.
      \item L'utente può visualizzare le regole di ogni minigioco in ogni momento.
      \item L'utente può visualizzare il proprio progresso, dipendente dalle regole, durante
            un minigioco.
      \item L'utente può visualizzare l'esito di un minigioco al termine di esso.
      \item L'utente può visualizzare l'esito del gioco al termine di una partita.
\end{itemize}
...
\begin{itemize}
      ...
      \item Il sistema può generare un numero predefinito di tessere monadi e un solo piolo 
      per volta da posizionare sulla plancia.
      ...
      \item Il sistema può premiare un giocatore, se possiede abbastanza monadi, con un
            ...
            numero di monadi necessarie per ottenerlo.
...
\subsubsection{Minigiochi} \label{sec:functional-requirements:minigames}
...
\begin{itemize}
      ...
      \item \textbf{Memory}\par
            \begin{itemize}
                  ...
                  \item Il sistema può terminare il minigioco quando tutte le coppie sono state trovate o quando il tempo massimo
                        è stato raggiunto.
            \end{itemize}
      \item \textbf{Puzzle} \par
            \begin{itemize}
                  \item Il sistema può generare un setup di gioco valido per il minigioco Puzzle.
                  \item Il sistema può verificare se una soluzione è corretta.
                  \item Il sistema può verificare se il giocatore ha completato il puzzle entro il tempo limite.
                  \item Il sistema permette di posizionare e spostare i pezzi del puzzle. 
            \end{itemize}
\end{itemize}