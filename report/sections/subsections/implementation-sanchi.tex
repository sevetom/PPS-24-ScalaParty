...
è sviluppato in stile funzionale e immutabile. Un aspetto interessdante dell'implmenetazione è che la scacchiera del memory è 
...
salvare non solo la posizione x e y della cella, ma anche il suo stato (aperta o chiusa) e per fare ciò ho utiliziato un sealed
