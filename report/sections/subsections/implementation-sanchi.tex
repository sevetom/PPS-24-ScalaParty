...
Oltre a questo, ho implementato tre semplici regole che mi permettono di ordinare e di inserire in una lista ordinata i dati
ottenuti che, nel mio caso, sono triple del tipo (d, x, y) dove d è la distanza manhattan tra l'avversario e l'oggetto collezionabile e
